...
const welcome = { role: 'assistant', content: 'Hello! Ask in simple words—even short messages or spelling mistakes are okay. I can explain VFS Groups services, documents, applications, and tracking.' };
